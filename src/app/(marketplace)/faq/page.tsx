...
export const metadata: Metadata = {
  title: 'FAQ - Vindu Vilahi',
  description: 'Frequently asked questions about ordering, payments, shipping, and returns at Vindu Vilahi.',
  openGraph: {
    title: 'FAQ - Vindu Vilahi',
    description: 'Find answers to common questions about shopping at Vindu Vilahi.',
    type: 'website',
  },
};
