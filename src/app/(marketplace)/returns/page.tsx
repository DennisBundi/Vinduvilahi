...
export const metadata: Metadata = {
  title: 'Returns & Exchanges - Vindu Vilahi',
  description: 'Our return and exchange policy. Learn how to return or exchange items purchased from Vindu Vilahi.',
  openGraph: {
    title: 'Returns & Exchanges - Vindu Vilahi',
    description: 'Return and exchange policy for Vindu Vilahi purchases.',
    type: 'website',
  },
};
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700">
                  Email us at returns@vinduvilahi.com or call +254 700 000 000 to initiate
