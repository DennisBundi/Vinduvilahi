...
export const metadata: Metadata = {
  title: 'About Us - Vindu Vilahi',
  description: 'Learn about Vindu Vilahi, your trusted fashion destination in Kenya. Quality fashion, fast delivery, and excellent customer service.',
  openGraph: {
    title: 'About Us - Vindu Vilahi',
    description: 'Learn about Vindu Vilahi, your trusted fashion destination in Kenya.',
    type: 'website',
  },
};
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4">
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Vindu Vilahi was founded with a passion for bringing the latest fashion trends
