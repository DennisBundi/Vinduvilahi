...
export const metadata: Metadata = {
  title: "Vindu Vilahi - Fashion Marketplace in Kenya",
  description:
    "Discover the latest fashion trends at Vindu Vilahi. Shop premium clothing, accessories, and more with fast delivery across Kenya.",
  openGraph: {
    title: "Vindu Vilahi - Fashion Marketplace in Kenya",
    description:
      "Discover the latest fashion trends at Vindu Vilahi. Shop premium clothing, accessories, and more with fast delivery across Kenya.",
