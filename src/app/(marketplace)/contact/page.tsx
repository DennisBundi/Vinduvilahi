...
export const metadata: Metadata = {
  title: 'Contact Us - Vindu Vilahi',
  description: 'Get in touch with Vindu Vilahi. Email, phone, or visit us at Westlands Shopping Centre, Nairobi, Kenya.',
  openGraph: {
    title: 'Contact Us - Vindu Vilahi',
    description: 'Get in touch with Vindu Vilahi for any inquiries or support.',
    type: 'website',
  },
};
          ...
          <div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700">info@vinduvilahi.com</p>
                <p className="text-gray-700">support@vinduvilahi.com</p>
              </div>
