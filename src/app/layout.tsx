...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/images/vinduvilahi-logo-square.png", sizes: "any", type: "image/png" },
      { url: "/images/vinduvilahi-logo-square.png", sizes: "32x32", type: "image/png" },
      { url: "/images/vinduvilahi-logo-square.png", sizes: "192x192", type: "image/png" },
      { url: "/images/vinduvilahi-logo-square.png", sizes: "512x512", type: "image/png" },
    ],
    apple: [
      { url: "/images/vinduvilahi-logo-square.png", sizes: "152x152", type: "image/png" },
      { url: "/images/vinduvilahi-logo-square.png", sizes: "192x192", type: "image/png" },
    ],
  },
};
